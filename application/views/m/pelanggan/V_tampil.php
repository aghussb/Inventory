<div class="container pos">
	<div id="toolbar" class="btn-group tab">
		<button type="button" onclick="add_pelanggan()" class="btn btn-default">
			<i class="glyphicon glyphicon-plus"></i>
		</button>
		<button type="button" id="update_pelanggan" class="btn btn-default">
			<i class="glyphicon glyphicon-edit"></i>
		</button>
		<button type="button" id="delete_pelanggan" class="btn btn-default">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $('#table').DataTable({
			...
			"bLengthChange": false,
			"ajax": {
				"url": '<?php echo site_url('m/C_pelanggan/table_list'); ?>',
				"type": "POST"
			},
			"columns": [
			{"data": "id"},
		...
		$('#delete_pelanggan').click(function(){
			...
			if(id.length === 0){
				...
				modalConfirm(function(confirm){
					if(confirm){
						$.ajax({
							url : "<?php echo site_url('m/C_pelanggan/pelanggan_delete')?>",
							method:'POST',
							data:{id:id},
							success:function()
							{
		...
		$('#update_pelanggan').click(function(){
			var id = [];
			$(':checkbox:checked').each(function(i){
				id[i] = $(this).val();
			});
	...
	{
		save_method = 'add';
		$('#form_pelanggan')[0].reset(); // reset form on modals
	...
	function edit_pelanggan(id)
	{
		...
		$.ajax({
			url : "<?php echo site_url('m/C_pelanggan/get_id/')?>/" + id,
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{
				...
				$('.modal-title').text('Update Pelanggan'); // Set title to Bootstrap modal title
	...
	function save()
	{
		...
		if(save_method == 'add') {
			url = "<?php echo site_url('m/C_pelanggan/pelanggan_insert')?>";
		}
		else {
			url = "<?php echo site_url('m/C_pelanggan/pelanggan_update')?>";
		}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body form">
				<form action="#" id="form_pelanggan" class="form-horizontal">
					<input type="hidden" value="" name="id"/>
					<div class="form-body">

						<div class="form-group">
							<label class="control-label col-md-3 lbl">Nama Pelanggan</label>
							<div class="col-md-9">
