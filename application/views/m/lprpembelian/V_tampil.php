<div style="margin-top: 80px;">
	<div style="margin: 0px 25px;">
		...
		<div class="panel panel-default">
			<div class="panel-heading">Laporan Pembelian Transaksi</div>
			<div class="panel-body">
				<div class="form-row">
					<div class="form-group col-md-4">
						<label class="lbl">Nama Suplier</label>
						<select name="nama" id="nama" class="selectpicker form-control" data-live-search="true" placeholder="Nama Suplier" required>
							<option></option>
							<?php
		...
		<div class="panel panel-default">
			<div class="panel-heading">Table Laporan Pembelian</div>
			<div class="panel-body">
...
<script type="text/javascript">
	$(document).ready( function () {
		table = $('#table').DataTable({
			...
			"bLengthChange": false,
			"ajax": {
				"url": '<?php echo site_url('m/C_laporanpmbl/table_list')?>',
				"type": "POST",
				"data": function (data) {
					data.nama    = $('#nama').val();
